...
class QueryPurchasesRequest extends Request
{
    ...
    protected $rules = [
        ...
        'orderId'        => 'required_without_all:startDate,endDate,customerId,purchaseId|max:30',
        'purchaseId'     => 'required_without_all:startDate,endDate,orderId,customerId|max:30',
        'customerId'     => 'required_without_all:startDate,endDate,purchaseId,orderId|numeric',
        'firstName'      => 'max:30',
        'lastName'       => 'max:30',
        'emailAddress'   => 'email|max:255',
        'phoneNumber'    => 'max:20|regex:/^[0-9-]+$/',
        'dateRangeType'  => 'in:dateCreated,dateUpdated',
        'startDate'      => 'required_without_all:customerId,purchaseId,orderId|date_format:"m/d/Y"|before:endDate',
        'endDate'        => 'required_without_all:customerId,purchaseId,orderId|date_format:"m/d/Y"|after:startDate',
