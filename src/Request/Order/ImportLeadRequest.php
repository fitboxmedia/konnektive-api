...
class ImportLeadRequest extends Request
{
    ...
    protected $rules = [
        ...
        'companyName'          => 'max:30',
        'address1'             => 'required_without:billShipSame|required_if:billShipSame,true|size:30',
        'address2'             => 'max:30',
        'postalCode'           => 'required_without:billShipSame|required_if:billShipSame,true|size:20',
        'city'                 => 'required_without:billShipSame|required_if:billShipSame,true|size:30',
        'state'                => 'required_without:billShipSame|required_if:billShipSame,true|size:6',
        'country'              => 'required_without:billShipSame|required_if:billShipSame,true|size:2',
