...
class QueryOrderRequest extends Request
{
    ...
    protected $rules = [
        ...
        'startDate'      => 'required_without:orderId|date_format:m/d/Y|before_or_equal:endDate',
        'endDate'        => 'required_without:orderId|date_format:m/d/Y|after_or_equal:startDate',
